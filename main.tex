...
% Remember to change article number for active membership if it changes.
Individuals holding office must be considered active student members of the \clubfullname per Section XIII, as of at least two weeks prior to their election.
...
\subsection{Eligibility}
% Remember to change the article number of the active student member article here if it changes.
The officer must be an active member, per Article XIII.
...
A student enrolled at UF is considered an active student member during a semester if:
\begin{enumerate}
	\item Attended at least 3 events hosted, co-hosted, or primarily funded by \clubname, or
	\item Attended at least 3 events hosted, co-hosted, or primarily funded by an Eligible Partner Organization.
\end{enumerate}
The term ``primarily funded'' means that the club provided 51% or more of the funds and/or supplies required to perform the event.

\section{Eligible Partner Organization (EPO)}
From time to time, the executive board may find certain student organizations to have similar goals to \clubname may want for \clubname to work with them more closely than a regular student organization partnership. These ``Eligible Partner Organizations'' shall be designated be the executive board. All Eligible Partner Organizations (EPOs) must meet all of the following requirements:
\begin{enumerate}
	\item The organization is a Registered Student Organization (RSO) at the University of Florida,
	\item The organization's primary mission is related to computer or information security, and
	\item The organization is an independent organization with no legal affiliation to the University of Florida or any of its entities.
\end{enumerate}

The list of Eligible Partner Organizations shall be published in a prominent location on the website of \clubname.
...
\begin{enumerate}
	\item Unianimous agreement of a Constitutional Committee composed of at least 1 \clubname board member and at least 2 active student members, or
	\item Unianimous agreement of a Constitutional Committee composed of at least 1 board member of an Eligible Partner Organization and at least 3 active student members, or
	\item Unianimous agreement of a Constitutional Committee composed of at least 5 active student members.
\end{enumerate}
Proposed amendments shall be submitted to the general body for ratification subject to any procedures outlined in bylaws. Amendments must be ratified to take effect. The Constitutional Committee shall assess the effect the amendment will have on the budget of \clubname. Amendments proposed by a Constitutional Committee without a \clubname board member must include a statement of the anticipated effect on the budget of \clubname.
...
The President is responsible for calling all general and officer meetings. In the absence of the President, the Vice President has the authority to call a meeting. The Director of Communications Secretary is responsible for making a good faith effort to inform all members of any meeting. Such notification must be issued at least 72 hours prior to any meeting.
