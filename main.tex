...
\end{enumerate}
Proposed amendments shall be submitted to the general body for ratification subject to any procedures outlined in bylaws. Amendments must be ratified to take effect. Amendments proposed by a Constitutional Committee without a \clubname board member must include a statement of the anticipated effect on the budget of \clubname.
